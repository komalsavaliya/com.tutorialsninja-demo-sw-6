...
public class Utility extends ManageBrowser {
     ...
     */
    public void clickOnElement(List<WebElement> by) {
    ...
    public void clearTextFromField(WebElement by) {
        driver.findElement((By) by).sendKeys(Keys.CONTROL + "a");
...
//*************************** Action Methods ***************************************//
    ...
    public WebElement waitUntilVisibilityOfElementLocated(WebElement by, int time) {
        ...
        return wait.until(ExpectedConditions.visibilityOfElementLocated((By) by));
    }
